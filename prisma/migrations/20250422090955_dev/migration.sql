...
INSERT INTO "new_Site" ("categoryId", "description", "id", "imageMode", "imageUrl", "order", "title", "url") SELECT "categoryId", "description", "id", "imageMode", "imageUrl", "order", "title", "url" FROM "Site";
DROP TABLE "Site";
